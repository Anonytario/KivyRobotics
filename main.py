...
clientID = simxStart('192.168.0.109',19999,True,True,5000,5)
simxAddStatusbarMessage(clientID,'Funcionando...',simx_opmode_oneshot_wait)
simxFinish(-1) # just in case, close all opened connections
clientID=simxStart('192.168.0.109',19999,True,True,5000,5) # Connect to CoppeliaSim
...
erro, robot = simxGetObjectHandle(clientID, robotname, simx_opmode_oneshot_wait)
[erro, robotLeftMotor] = simxGetObjectHandle(clientID, 'DynamicLeftJoint',simx_opmode_oneshot_wait)
[erro, robotRightMotor] = simxGetObjectHandle(clientID, 'DynamicRightJoint', simx_opmode_oneshot_wait)
...
class PongGame(Widget):
    ...
    def pressR(self):
        ...
        simxSetJointTargetVelocity(clientID, robotRightMotor, vref, simx_opmode_oneshot)
    ...
    def pressL(self):
        vref = 1.0
        simxPauseCommunication(clientID, True)
        simxSetJointTargetVelocity(clientID, robotLeftMotor, vref, simx_opmode_oneshot)
        simxPauseCommunication(clientID, False)
